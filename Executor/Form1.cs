        ...
        private async Task EnsureWebView2InitializedAsync(Microsoft.Web.WebView2.WinForms.WebView2 webView)
{
    ...
    catch (Exception ex)
    {
        ...
        private async void CheckVersion()
        {
            ...
            {
                MessageBox.Show("Current version: " + localVersion +". Please download version " + infoJson["SoftwareVersion"] + " via Bootstrapper.", "Version Checker | Exter Executor", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
    ...
    public static class AppSettingsManager
    {
        ...
        public static AppSettings LoadSettings()
        {
            if (!File.Exists(FilePath))
            {
                ...
                return new AppSettings() { IsTopmost = false, DisableConfirm = true, ChosenApi = "QuorumAPI", MinimapToggle = true };
            }
