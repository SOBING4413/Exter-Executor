    ...
    public partial class Home : Form
    {
        ...
        private async void guna2Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // Change the button text to indicate the link is copied and opened
            ...
            {
                // Handle any errors that might occur (e.g., if the browser cannot be opened)
        ...
        {
            Login loginform = new Login(); // Opens Login Window
